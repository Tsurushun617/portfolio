...
<head>
  ...
  <!-- ▼ファビコン -->
  <link rel="icon" type="image" sizes="32✕32" href="<?php echo esc_url(get_template_directory_uri()); ?>/images/common/favicon.png" />
...
<body <?php body_class(''); ?>>
  ...
  <header class="header">
    <div class="header-container w-container">
      <!-- ▼ ロゴ -->
      <h1 class="site-title">
        <a href="<?php echo esc_url(home_url('/')); ?>"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/common/logo.png" alt="<?php bloginfo('name'); ?>" /></a>
      </h1>
      <!-- ▲ ロゴ -->
      <!-- 🍔ボタン（クリックする３本線の部分） -->
